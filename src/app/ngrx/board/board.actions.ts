...
export const createBoardFail = createAction('[Board] Create Board Fail', props<{ error: string }>());
...
export const getBoardsFail = createAction('[Board] Get Boards Fail', props<{ error: string }>());

export const getBoard = createAction('[Board] Get Board Actions', props<{ boardId: string }>());
export const getBoardSuccess = createAction('[Board] Get Board Actions Success', props<{ board: BoardModel }>());
